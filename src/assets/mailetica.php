<?php
    ...
    if ($_POST['g-recaptcha-response'] == '') {
		...
		if (true) {
			...
			$mail->Body = "Nombre y Apellido: " . $nombre ."<br>". "Email: " . $email ."<br>"." Reclamo/Denuncia". $asunto."<br>". "Telefono: " . $telefono . "Mensaje: " . $mensaje;
			$mail->AddAddress("etica@elmejor.com.py");
			$mail->Send();

			header("Location: ../etica.html?enviado=1");
		} else {
			echo "Captcha invalido";
		}
	}
